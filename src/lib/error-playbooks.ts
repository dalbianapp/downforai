    ...
    errors: [
      {
        ...
        causes: [
          ...
          "{service} is experiencing a platform-wide capacity crunch due to high demand",
        ...
        fixSteps: [
          ...
          "Use {service}'s capacity reservation feature if available — reserved instances guarantee access regardless of spot availability",
          "Schedule batch jobs during off-peak hours (weekends, early morning UTC) when demand is lower",
          "Check {service}'s status page and community reports on this page for real-time capacity signals",
          "Consider a multi-cloud or multi-provider strategy: fall back to a secondary provider when {service} is at capacity",
          "Contact {service} enterprise sales if you need guaranteed sustained capacity — reserved compute contracts bypass spot shortages",
        ],
        errorSignatures: [
          "No GPU available",
        ...
        faq: [
          {
            q: "Why are {service} GPUs unavailable even though I'm paying for them?",
          ...
          {
            q: "What GPU types are most likely to be available on {service}?",
            a: "Lower-end GPUs (T4, A10, L4) typically have more availability than flagship models (A100, H100). For inference tasks, an A10G or L4 often delivers similar throughput to an A100 at a fraction of the cost and with far better availability. Benchmark your model on the lower tier before committing to scarce high-end GPUs.",
          },
          {
            q: "When will {service} GPU capacity be restored?",
            a: "Capacity windows are unpredictable and fluctuate hourly. Off-peak hours (late night or early morning UTC, weekends) typically see better availability. Check the live signals and community reports on this page for real-time feedback from other users currently trying to provision GPUs on {service}.",
          },
          {
            q: "How do I avoid GPU unavailability in production?",
            a: "The most reliable approach is reserved capacity: pre-purchase compute hours from {service} at a committed rate, which guarantees access. For less critical workloads, implement retry logic with exponential backoff and multi-region fallback so your system automatically finds available capacity without manual intervention.",
          },
          {
            q: "Is GPU unavailability a {service} outage or a capacity issue?",
            a: "These are distinct situations. An outage means {service}'s infrastructure is broken — APIs return errors across all operations. Capacity unavailability means the platform is healthy but the specific resource you requested is sold out. Check the live status on this page: if only GPU provisioning fails while other API calls succeed, it's a capacity issue, not a platform outage.",
          },
        ],
        hasHowToSchema: true,
      },

      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 16px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "32px", marginBottom: "32px" }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
              <Link href="/speed-index" style={{ fontSize: "13px", color: "#a3a3a3", textDecoration: "none" }}>LLM Speed Index</Link>
              ...
              <Link href="/reports" style={{ fontSize: "13px", color: "#a3a3a3", textDecoration: "none" }}>Reports</Link>
              ...
              <Link href="/developers" style={{ fontSize: "13px", color: "#a3a3a3", textDecoration: "none" }}>Developers</Link>
